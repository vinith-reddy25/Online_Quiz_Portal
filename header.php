...
<table border="0" width="100%" cellspacing="0" cellpadding="0" style="background-color:rgb(0,0,0);">
  <tr>
    <td width="90%" valign="top">
<!--You can modify the text, color, size, number of loops and more on the flash header by editing the text file (fence.txt) included in the file.-->
...
scale= showall>
    ...
    <td width="10%">
     <img border="0" src="image/topright2.gif" width="203" height="68" align="right"></td>
  </tr>
</table>
