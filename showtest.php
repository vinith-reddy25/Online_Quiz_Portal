...
$rs1=mysqli_query($cn,$q)or die("Could Not Perform the Query".mysqli_error($cn));
$row1=mysqli_fetch_array($rs1);
echo "<h1 align=center><font color=blue> $row1[1]</font></h1>";
$n="select * from mst_test where sub_id=$subid";
$rs=mysqli_query($cn,$n)or die("Could Not Perform the Query".mysqli_error($cn));
