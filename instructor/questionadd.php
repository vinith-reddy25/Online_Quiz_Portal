...
{
extract($_POST);
$a="insert into mst_question(test_id,que_desc,ans1,ans2,ans3,ans4,true_ans) values ('$testid','$addque','$ans1','$ans2','$ans3','$ans4','$anstrue')";
...
<?php
$b="Select * from mst_test order by test_name";
$rs=mysqli_query($cn,$b);
