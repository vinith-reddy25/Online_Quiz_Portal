...
if (!isset($_SESSION['alogin']))
{
	...
	echo "<a href=index1.php><h3 align=center>Click Here for Login</h3></a>";
	exit();
}
?>
...
{
extract($_POST);
$a="insert into mst_test(sub_id,test_name,total_que) values ('$subid','$testname','$totque')";
mysqli_query($cn,$a)or die("Could Not Perform the Query".mysqli_error($cn));
...
<?php
$b="Select * from mst_subject order by  sub_name";
$rs=mysqli_query($cn,$b)or die("Could Not Perform the Query".mysqli_error($cn));
