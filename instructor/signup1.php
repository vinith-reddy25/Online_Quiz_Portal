...
<body>
   ...
   include("header.php");
	...
	$count=0;
	$cn=mysqli_connect("localhost","root","kancheepuram") or die("Could not Connect My Sql".mysqli_error($cn));
...
<table width="100%" border="0">
   ...
   <tr>
   <td>
     <p style = "text-align:center;"> Already have an account? <a href="index1.php" style="padding-left:10px;"> Login</a></p>
   </td>
   </tr>
 </table>
 <p>&nbsp; </p>
