...
if(isset($submit))
{
	...
	$q="select * from mst_admin where loginid='$loginid' and pass='$pass'";
	$rs=mysqli_query($cn,$q)or die("Could Not Perform the Query".mysqli_error($cn));
	if(mysqli_num_rows($rs)<1)
	{
		echo "<BR><BR><BR><BR><div class=head1> Invalid User Name or Password<br>Please<a href=index.php>Login</a><div>";
		exit;
...
<p class="style7"><a href="view.php">view users detail's</a></p>
