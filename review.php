...
if($submit=='Finish')
{
	$q="delete from mst_useranswer where sess_id='" . session_id() ."'";
	mysqli_query($cn,$q)or die("Could Not Perform the Query".mysqli_error($cn));
	unset($_SESSION[qn]);
...
$w="select * from mst_useranswer where sess_id='" . session_id() ."'";
$rs=mysqli_query($cn,$w)or die("Could Not Perform the Query".mysqli_error($cn));
